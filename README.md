...
You can then access the Petclinic at <http://localhost:8085/>.
...
gets populated at startup with data. The h2 console is exposed at `http://localhost:8085/h2-console`,
